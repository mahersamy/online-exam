import { Component, AfterViewInit, ElementRef, ViewChild, output, signal, input } from '@angular/core';
...
@Component({
  ...
  imports: [CustomModalComponent, QuizButtonComponent, QuizScoreCorrectNumberComponent, QuizCorrectAwnserComponent],
})
